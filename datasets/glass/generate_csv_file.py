...
create_csv_file("glass_prob_forest.csv",
"glass_classes.csv",
"glass_predict_forest.csv",
"glass_attr.csv",
"distance_glass_attr.csv",
"glass_random_forest")

create_csv_file("glass_prob_svm.csv",
"glass_classes.csv",
"glass_predict_svm.csv",
"glass_attr.csv",
"distance_glass_attr.csv",
"glass_svm")

create_csv_file("glass_prob_kneigh.csv",
"glass_classes.csv",
"glass_predicted_kneigh.csv",
"glass_attr.csv",
"distance_glass_attr.csv",
"glass_kneigh")
