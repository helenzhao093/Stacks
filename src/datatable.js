...
function DataTable(dataModel, appSettings){
  ...
  // default check boxes
  $('#tn').prop("checked", appSettings.display.TN)
  $('#tp').prop("checked", appSettings.display.TP)
  $('#fn').prop("checked", appSettings.display.FN)
  $('#fp').prop("checked", appSettings.display.FP)
  ...
  $('#datatable tbody').on( 'click', 'tr', function () {
    drawPath(table.row(this).data(), dataModel);
  ...
  $('#filter').on('click', function(e){
    e.preventDefault();
    appSettings.TPThreshold = $('#tp-threshold').val()
    appSettings.TNThreshold = $('#tn-threshold').val()
    appSettings.display.TN = $('#tn').is(":checked")
    appSettings.display.TP = $('#tp').is(":checked")
    appSettings.display.FN = $('#fn').is(":checked")
    appSettings.display.FP = $('#fp').is(":checked")
