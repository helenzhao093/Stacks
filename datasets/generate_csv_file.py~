...
create_csv_file("proba_4_classes_random_forest.csv", "actual_4_classes.csv", "predicted_4_classes_random_forest.csv", "features_4_classes.csv", "1000_random_forest_4_classes")
